  ...
  await getResend().emails.send({
    ...
    html: `
      <div style="font-family: Georgia, serif; background:#0b0b0c; color:#f2efe9; padding:32px; max-width:520px; margin:0 auto;">
        ...
        <p style="font-size:13px; line-height:1.6; color:#b8b3a9;">This link works once and expires in 14 days, so please save the files somewhere safe after downloading. If you run into any trouble, just reply to this email.</p>
