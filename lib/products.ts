...
export const products: Product[] = [
  {
    ...
    accent: "crystal",
    origin: "Recorded among crystal glasses, quartz formations and mountain ice",
    description:
      "A cinematic collection crafted from crystal glasses, quartz, ice and shimmering resonances, capturing the delicate beauty of light reflected through crystal.",
    longDescription: [
      "Crystal Sounds began in a quiet cave of quartz, where a single struck glass rang out and refused to fade. That resonance — thin, pure, endlessly sustaining — became the seed of this entire library.",
      "Every layer was captured from real crystal glasses tuned by hand, shards of quartz bowed and struck, and mountain ice recorded as it cracked and settled. Nothing here is synthesized from nothing; every texture began as a vibration in the physical world.",
      "The result is an instrument for moments of clarity and wonder — for scenes where light seems to make a sound of its own.",
    ],
    features: [
      "128 deep-sampled crystal and quartz instruments",
      "40+ evolving pads built from bowed glass resonance",
      "Multi-mic'd ice recordings from Costa Rican highlands",
